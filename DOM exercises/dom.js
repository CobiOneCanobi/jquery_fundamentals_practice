...
logo.style.background = url("http://www.underconsideration.com/brandnew/archives/yahoo_logo_detail.png");

searchText = document.querySelector("input[value='Google Search']");
searchText.value = "Yahoooo!"
...
//  </body>
  ...
  //   nickname.innerHTML = "CobiOneCanobi";

  //   var favorites = document.getElementById("favorites");
  //   favorites.innerHTML = "Eat, Sleep, Code";
  ...
  //   newImg.src = "http://prono.acsimodulo.com/Icons/Simpsons_Homer.jpg";
